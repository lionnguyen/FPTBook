   ...
   // [Authorize(Roles ="Seller")]
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int id)
        {
            ...
            var fPTBookContext = _context.OrderDetail
                .Where(o => o.Order.UId == thisUsersId && o.OrderId == id)
                .Include(o => o.Book)
                .Include(o => o.Order)
        ...
        {
            var orderManager = _context.OrderDetail
                .Where(o => o.OrderId == id)
                .Include(o => o.Book)
                .Include(o => o.Order).Include(o => o.Order.User)
                .Include(o => o.Book.Store);
